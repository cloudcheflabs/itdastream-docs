...
itdastream is a high-performance, S3-compatible object storage system designed for high availability
...
Control & Logic Layer (API Servers) is the "Brain" of itdastream. It interprets the S3 protocol and orchestrates data movement.
...
itdastream has the following architectural advantages.
